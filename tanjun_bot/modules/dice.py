...
# is that?!
@tanjun.with_int_slash_option("number", "The number of dice to roll.", min_value=1, max_value=25)
# These next two are the same, but are optional. Setting a default value
# automatically marks it as optional.
@tanjun.with_int_slash_option("sides", "The number of sides each die will have.", default=6, min_value=0, max_value=100)
@tanjun.with_int_slash_option(
    "bonus", "A fixed number to add to the total roll.", default=0, min_value=0, max_value=100
)
